  ...
  return (
    <section id="archive" className="py-12 md:py-20 relative min-h-[600px] md:min-h-[700px] overflow-hidden px-4">
      ...
      <div className="mx-auto max-w-2xl relative mt-16 md:mt-20 px-4">
        ...
        >
          <span className="text-white font-black text-4xl md:text-7xl font-headline">A</span>
        </motion.div>
      </div>
    </section>
  );
...
export const FinalSection = () => {
  return (
    <section className="py-20 md:py-32 text-center px-4 overflow-hidden relative">
      <motion.div
        initial={{ scale: 0.9, opacity: 0 }}
        whileInView={{ scale: 1, opacity: 1 }}
        className="max-w-3xl mx-auto scrapbook-card border-4 md:border-8 border-dotted border-primary p-6 md:p-16 -rotate-2 shadow-[20px_20px_0px_rgba(0,0,0,0.1)] relative z-10"
      >
        ...
        <div className="mt-10 md:mt-16 flex flex-wrap justify-center gap-4 md:gap-6">
          ...
          <span className="bg-pink-400 text-white px-4 md:px-6 py-1 md:py-2 border-2 border-black -rotate-3 font-black text-lg md:text-2xl shadow-sm">Akshyaverse Team</span>
        </div>
      </motion.div>
      <div className="mt-16 mx-auto max-w-sm relative z-0">
        <motion.img
          initial={{ rotate: 0 }}
          whileHover={{ rotate: -3 }}
          className="w-full sticker-border rotate-3 shadow-xl"
          src="/images/pic4.jpg"
          alt="Akshya Memory"
        />
      </div>
