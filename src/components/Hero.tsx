...
export const Hero = () => {
  return (
    <section className="relative pt-40 md:pt-48 pb-32 flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      />
      <Sticker 
        src="https://lh3.googleusercontent.com/aida-public/AB6AXuBFjk5JVXQPM9aq-ZsN60T2nlfh2D2KMbNcyTeq1-_cPSs6tVV_wQIHBxA9zkWPZDn4Fc5aZGgQgUZJrch7J9SLfDY0T7QifngIdotn8UtrM_17wskRG3HBK0PCnEMOHbHYMPhpXhwZ8Y4zO-CRSjPmZExe7HIwiPTHL6yW6Sr7gIJSKAXUEqkQRPs0u_IGs58F9-spr7Oezg1zwhTxxlqXuyjik-gAQVUBTkHS27c5TaPjmTCXo20B8gb9UEZYDYaTf_Lo1fD-AxM"
        alt="Chai"
        tilt="right"
        size="lg"
      ...
      >
        <h1 className="font-headline text-[13vw] md:text-[clamp(5rem,12vw,9rem)] leading-[0.9] text-primary drop-shadow-[4px_4px_0px_#000000] md:drop-shadow-[10px_10px_0px_#000000] relative z-20 font-black uppercase">
          MAHAK <br className="md:hidden" /> RAWANI
        </h1>
        <motion.div 
          initial={{ rotate: 0 }}
          animate={{ rotate: 12 }}
      ...
      >
        Boss girl energy. <br className="hidden md:block" /> <span className="bg-pink-200 px-2 italic">Tulip heart.</span> <span className="underline decoration-yellow-400 decoration-8">Chai soul.</span>
      </motion.p>
