...
export const MusicSection = () => {
  const songs = [
    { title: "Tu Chahiye", artist: "Pritam, Atif Aslam", color: "bg-red-200", coverUrl: "https://i.ytimg.com/vi/zuvla6ABKbs/maxresdefault.jpg", youtubeId: "zuvla6ABKbs" },
    { title: "Aaj Din Chadeya", artist: "Rahat Fateh Ali Khan", color: "bg-orange-200", coverUrl: "https://i.ytimg.com/vi/IImcBEHuDRI/maxresdefault.jpg", youtubeId: "IImcBEHuDRI" },
    { title: "Aashiq Tera", artist: "Sohail Sen, Altamash Faridi", color: "bg-yellow-200", coverUrl: "https://i.ytimg.com/vi/emh8zR4ZqZ0/maxresdefault.jpg", youtubeId: "emh8zR4ZqZ0" },
    { title: "Tere Bin", artist: "Atif Aslam", color: "bg-green-200", coverUrl: "https://i.ytimg.com/vi/hejXc_FSYb8/maxresdefault.jpg", youtubeId: "hejXc_FSYb8" },
    { title: "Ishqa Ve", artist: "Javed Ali", color: "bg-teal-200", coverUrl: "https://i.ytimg.com/vi/j18MRhEfmPk/maxresdefault.jpg", youtubeId: "j18MRhEfmPk" },
    { title: "Laggab Lagi", artist: "Sukhwinder Singh", color: "bg-blue-200", coverUrl: "https://i.ytimg.com/vi/CIr3TCIDAOs/maxresdefault.jpg", youtubeId: "CIr3TCIDAOs" },
    { title: "Bairan", artist: "Arijit Singh", color: "bg-indigo-200", coverUrl: "https://i.ytimg.com/vi/oafxkMv4xnc/maxresdefault.jpg", youtubeId: "oafxkMv4xnc" },
    { title: "Tere Bina na Guzara E", artist: "Rahat Fateh Ali Khan", color: "bg-purple-200", coverUrl: "https://i.ytimg.com/vi/aYG6oEUXyuQ/maxresdefault.jpg", youtubeId: "aYG6oEUXyuQ" },
    { title: "Suniyan Suniyan", artist: "Juss", color: "bg-pink-200", coverUrl: "https://i.ytimg.com/vi/AKH6ZNSnWOA/maxresdefault.jpg", youtubeId: "AKH6ZNSnWOA" },
    { title: "I Love You", artist: "Ash King", color: "bg-rose-300", coverUrl: "https://i.ytimg.com/vi/0JLRExeOH-k/maxresdefault.jpg", youtubeId: "0JLRExeOH-k" },
  ];

  const [currentIdx, setCurrentIdx] = useState(0); // Default to Tu Chahiye
